...
const EditSurvey = () => {
  ...
  const validateEditedSurvey = () => {
    ...
    if (editedSurvey.setExpireDate && (!editedSurvey.expireDate || new Date(editedSurvey.expireDate) - new Date() < 7 * 24 * 60 * 60 * 1000)) {
  ...
  const handleEditInputChange = (name) => (event) => {
                ...
                <>
                  ...
                  <Typography>
                    ...
                    <RadioGroup
                      ...
                      onChange={(event) => setEditedSurvey({ ...editedSurvey, setExpireDate: event.target.value === 'yes' })}
                    >
